                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="d-flex align-items-center">
                                            ...
                                            >
                                                <use
                                                        xlink:href="<?= "{$themeMazer->baseUrl}/assets/dist/static/images/bootstrap-icons.svg#circle-fill" ?>"
                                    ...
                                    <table class="table table-hover table-lg">
                                            ...
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="<?= "{$themeMazer->baseUrl}/assets/dist/compiled/jpg/5.jpg" ?>"/>
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="<?= "{$themeMazer->baseUrl}/assets/dist/compiled/jpg/2.jpg" ?>"/>
                                                    </div>
...
<?php
    ...
    $this->registerJsFile("{$themeMazer->baseUrl}/assets/original_assets/static/js/pages/dashboard.js", ['depends' => [\yii\web\JqueryAsset::class]]);
?>