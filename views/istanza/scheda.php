            ...
            <div class="col-md-2 d-flex flex-column align-items-center justify-content-center">
                <?php if (!$istanza->rinuncia): ?>
                    ...
                    <span class="badge rounded-pill bg-<?= ($istanza->data_decesso === null && $istanza->patto_di_cura && !$istanza->chiuso && $istanza->attivo) ? "success" : "danger" ?> text-small"><?=
                        $istanza->data_decesso !== null ? (($istanza->liquidazione_decesso_completata && $istanza->chiuso) ? "CHIUSO LIQUIDATO" : ($istanza->attivo ? "DECEDUTO ANCORA ATTIVO" : ($istanza->liquidazione_decesso_completata ? "LIQUIDATO NON ATTIVO <br />APERTO (CHIUDERE)" : ($istanza->attivo ? "ATTIVO DA LIQUIDARE" : "NON ATTIVO DA LIQUIDARE")))) : ($istanza->attivo ? "ATTIVO" : (!$istanza->patto_di_cura ? "" : ($istanza->rinuncia ? "RINUNCIA" : ($istanza->chiuso ? "NON ATTIVO, CHIUSO" : "NON ATTIVO, ATTENZIONARE")))) ?></span>
                <?php endif; ?>
                <?php if ($istanza->rinuncia): ?>
            ...
            <div class="col-md-12">
                <div class="card bg-body p-10">
                    <div class="card-body">
                        ...
                        ?>
                        <h5 class="card-title">Movimenti<i class="bi bi-info-circle" style="margin-left: 5px" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="<?= Html::encode("Totale dovuto dell'anno: <b>".Yii::$app->formatter->asCurrency($totaleDovuto) ."</b><br />Totale effettivo: <b>".Yii::$app->formatter->asCurrency($totaleEffettivo) ."</b><br />Differenza: <b>".Yii::$app->formatter->asCurrency($totaleDovuto - $totaleEffettivo)."</b>") ?>"></i></h5>
                        <?=
