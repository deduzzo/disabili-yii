        ...
        <div class="row p-1">
            <div class="col-md-2 d-flex flex-column align-items-center justify-content-center">
                <?php if (!$istanza->rinuncia): ?>
                    <span class="badge rounded-pill bg-<?= $istanza->data_decesso === null ? "success" : "danger" ?> text-small"><?= $istanza->data_decesso ? ("DECEDUTO " . Yii::$app->formatter->asDate($istanza->data_decesso)) : ($istanza->attivo ? "IN VITA" : "NON ATTIVO") ?></span>
