...
class Istanza extends \yii\db\ActiveRecord
{
    ...
    public function getGiorniResiduoDecesso() {
        ...
        $totaleGiorniDovuti = Utils::getNumGiorni(!$restituire ? $dataInizioDovuta : $this->data_decesso,!$restituire? Carbon::createFromFormat('Y-m-d', $this->data_decesso)->subDay()->format('Y-m-d'): $dataInizioDovuta);
